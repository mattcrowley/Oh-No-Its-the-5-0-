/*  Name: Matt Crowley, Matthew Rotter, Gabe Heuton, Yuhong Bao
	...
	Description: This is a Collision detecting file that I found online: 
				 http://www.sfml-dev.org/wiki/en/sources/simple_collision_detection
				 Since SFML does not have any collision detecting itself, I used this code as it was, with no changes.
*/
